  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 prose prose-stone prose-sm max-w-none">
        ...
        <p>Booking data is retained for 3 years for legal and warranty purposes. Account data is retained until you request deletion. You may request deletion by emailing <strong>privacy@snapfix.in</strong>.</p>
        ...
        <p>To exercise any of these rights, contact: <strong>privacy@snapfix.in</strong></p>

  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 prose prose-stone prose-sm max-w-none">
        ...
        <p>Booking data is retained for 3 years for legal and warranty purposes. Account data is retained until you request deletion. You may request deletion by emailing <strong>privacy@setuone.in</strong>.</p>
        ...
        <p>To exercise any of these rights, contact: <strong>privacy@setuone.in</strong></p>

        <h2>7. Cookies</h2>
        <p>We use session cookies to maintain your login state. No tracking cookies or advertising cookies are used.</p>

        <h2>8. Contact</h2>
        <p>Data Protection Officer: <strong>dpo@setuone.in</strong> · +91 77777 77777 · Indore, MP 452001</p>
      </div>
    </div>
  );
}

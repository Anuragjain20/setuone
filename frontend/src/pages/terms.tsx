  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 prose prose-stone prose-sm max-w-none">
        ...
        <h2>1. About SetuOne</h2>
        <p>SetuOne ("we", "us", "the platform") is a hyperlocal home-services marketplace connecting residents of Indore, Madhya Pradesh, with independent verified craftsmen ("Karigar"). By using this platform, you agree to these terms.</p>

        <h2>2. Services Provided</h2>
        <p>SetuOne provides a technology platform to facilitate bookings between customers and service professionals. We do not directly employ craftsmen — they are independent professionals. We are responsible for matching, verification, and quality assurance only.</p>
        ...
        <p>Prices shown are estimates. Actual charges depend on scope of work. A convenience fee of ₹75 applies to all bookings. Platform fee (15% of job value) is used to maintain the platform. All payments should be made through official SetuOne channels.</p>
        ...
        <h2>7. Liability</h2>
        <p>SetuOne's liability is limited to the amount paid for the specific booking in question. We are not liable for property damage caused by craftsmen — please ensure you report concerns immediately via the Report Issue feature.</p>
        ...
        <h2>10. Contact</h2>
        <p>For any legal queries, contact us at: <strong>legal@setuone.in</strong> or call <strong>+91 77777 77777</strong>.</p>
      </div>
    </div>
  );
}
